...
## Randbedingungen 
Die verwendete Programmierumbgebung ist JDK 8.0 Eclipse EE, für die graphischen Elemente wird ein im Eclipse installiertes Java FX verwendet werden. Wir wollen das Programm in verschiedene Klassen unterteilen und diese mit Methoden strukturieren. Um die Organisation mit mehreren Teilnehmern zu vereinfachen, verwenden wir Maven. Der Datenaustausch, sowie die Archivierung erfolgt in Git.
...
> _Ziel wurde erreicht, jedoch ist es uns nicht gelungen, dass der Timer angezeigt wird._
...
> Der Timer zählt von 60 Sekunden runter, um ein Zeitlimit zu haben.


### UML Package, Klassen- und Sequenzendiagramm
![Klassendiagramm](https://github.com/wegwerfWindbreaker/trinat/blob/master/documentary/Klassendiagramm.jpeg)
> Die Klasse "Main Animation" ist unsere Hauptklasse. Von dieser aus wird in der Methode "gameOver" die zweite Klasse countdown() aufgerufen
### Dokumentation wichtier Code Snippets
